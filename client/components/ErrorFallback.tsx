  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        <View style={[styles.iconCircle, { backgroundColor: Colors.light.error + "15" }]}>
        ...
        <ThemedText type="body" style={[styles.message, { color: theme.textSecondary }]}>
          O Morada AO encontrou um problema inesperado. Por favor, reinicia a app para continuar.
        </ThemedText>
